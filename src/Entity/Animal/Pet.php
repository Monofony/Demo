...
#[SyliusRoute(name: 'app_frontend_pet_book', path: '/pets/{slug}/book', methods: ['POST'], controller: 'app.controller.pet::applyStateMachineTransitionAction', requirements: ['slug' => '.+'], csrfProtection: false, redirect: ['route' => 'app_frontend_booking_confirmation', 'parameters' => ['slug' => 'resource.slug']], stateMachine: ['graph' => 'pet_booking', 'transition' => 'book'])]
